...
import {getUserDataFromFirebase, postUpdateCustomerInfo} from '@/utils/routes';
...
const UserProfile: React.FC = () => {
  ...
  const handleSave = async () => {
    if (currentUserUUID) {
      try {
        await postUpdateCustomerInfo(currentUserUUID, {
          name: userInfo.name,
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View
          style={{height: 0.5, backgroundColor: 'lightgray', marginBottom: 15}}
        />
