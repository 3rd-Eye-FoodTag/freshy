    ...
    return (
        <SafeAreaView style={styles.screen}>
            ...
            <Text style={styles.descriptionText}>
                We will let you see what’s expiring, plan meals and generate grocery list.
            </Text>
            <Text style={styles.descriptionText}>When is a good time for your wrap up?</Text>
            ...
            <UnstyleButton text='Continue' backgroundColor='rgb(81, 179, 125)' style={{ alignSelf: 'center' }} />
        </SafeAreaView>
