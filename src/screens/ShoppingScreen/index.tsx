...
import { Box, HStack, VStack, Checkbox, IconButton, Icon, Text, FlatList, Center, Heading, Button } from 'native-base';
        ...
        <Box flex={1} bg="white" px={4} py={2}>
            ...
            <FlatList
                ...
                >
                    ...
                    <Text strikeThrough={item.isChecked} color={item.isChecked ? 'gray.400' : 'black'} fontSize="md">
                        {item.name}
                    </Text>
                    </HStack>
                    <Checkbox
